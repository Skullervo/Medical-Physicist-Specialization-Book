...
urlpatterns = [
    ...
    path('radiologia/create_epa/', views.create_radiologia_epa, name='create_radiologia_epa'),
    ...
    path('radiologia/lapivalaisu-angiografia/add_section/', views.add_lapivalaisu_angiografia_section_view, name='add_lapivalaisu_angiografia_section_view'),
    path('radiologia/lapivalaisu-angiografia/edit_section/', views.edit_lapivalaisu_angiografia_section_view, name='edit_lapivalaisu_angiografia_section_view'),
    path('radiologia/lapivalaisu-angiografia/delete_section/', views.delete_lapivalaisu_angiografia_section_view, name='delete_lapivalaisu_angiografia_section_view'),
    ...
    path('radiologia/natiivikuvantaminen/save/', views.save_natiivikuvantaminen_content, name='save_natiivikuvantaminen_content'),
    path('radiologia/natiivikuvantaminen/add_section/', views.add_section_view, name='add_section_view'),
    ...
    path('radiologia/sateilybiologia-suojelu/add_section/', views.add_sateilybiologia_suojelu_section_view, name='add_sateilybiologia_suojelu_section_view'),
    path('radiologia/sateilybiologia-suojelu/edit_section/', views.edit_sateilybiologia_suojelu_section_view, name='edit_sateilybiologia_suojelu_section_view'),
    path('radiologia/sateilybiologia-suojelu/delete_section/', views.delete_sateilybiologia_suojelu_section_view, name='delete_sateilybiologia_suojelu_section_view'),
    ...
    path('sairaalafyysikot/', views.sairaalafyysikot_view, name='sairaalafyysikot'),
]
    path('epas/', views.epas_view, name='epas'),
    path('radiologia/lapivalaisu-angiografia/', views.radiologia_lapivalaisu_angiografia_view, name='radiologia_lapivalaisu_angiografia'),
    path('radiologia/lapivalaisu-angiografia/add_section/', views.add_lapivalaisu_angiografia_section_view, name='add_lapivalaisu_angiografia_section_view'),
    ...
    path('radiologia/ultraaani/add_section/', views.add_ultraaani_section_view, name='add_ultraaani_section_view'),
    path('radiologia/ultraaani/edit_section/', views.edit_ultraaani_section_view, name='edit_ultraaani_section_view'),
    path('radiologia/ultraääni/delete_section/', views.delete_ultraaani_section_view, name='delete_ultraaani_section_view'),
    path('radiologia/kuvankatselunaytot/', views.radiologia_kuvankatselunaytot_view, name='radiologia_kuvankatselunaytot'),
    path('radiologia/kuvankatselunaytot/add_section/', views.add_kuvankatselunaytot_section_view, name='add_kuvankatselunaytot_section_view'),
    path('radiologia/kuvankatselunaytot/edit_section/', views.edit_kuvankatselunaytot_section_view, name='edit_kuvankatselunaytot_section_view'),
    path('radiologia/kuvankatselunaytot/delete_section/', views.delete_kuvankatselunaytot_section_view, name='delete_kuvankatselunaytot_section_view'),
    ...
    # KNF (Kliininen neurofysiologia) sivut
